...
const Products = () => {
  ...
  const getProducts = async (page: number, pageSize: number, filters: any) => {
    ...
    body.append("rows", pageSize.toString());
    body.append("sort", "CreatedOn");
    body.append("order", "Desc");
    body.append("filterRules", JSON.stringify(filters.filter));
    ...
    <>
      ...
      <Card>
        <div className="flex flex-col gap-y-4">
          ...
          <Table data={data} columns={columns} rowKey="ProductID" />
          ...
          >
            ...
            >
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                ...
                >
                  <Input placeholder="کد انبار را وارد کنید" />
                </Form.Item>
                ...
                >
                  <Input placeholder="نام انبار را وارد کنید" />
                </Form.Item>
              ...
              <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
                <Form.Item label="شماره تماس (اختیاری)" name="phoneNumber">
                  <Input type="number" placeholder="شماره تماس را وارد کنید" />
                </Form.Item>
                <Form.Item label="کدپستی" name="postalCode">
                  <Input type="number" placeholder="کدپستی را وارد کنید" />
                </Form.Item>
